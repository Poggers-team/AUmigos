...
<section class="find-pet">
    <div class="container">
        ...
        <c:if test="${empty animals}">
            <p class="nothing-animal">Ainda não há registros de adoções.</p>
            <p class="nothing-animal">Que tal mudar isso? <a href="FrontController?action=animalList&adopted=false">Adote um animal agora!</a></p>
        </c:if>
        ...
        <div class="row">
            <c:forEach var="animal" items="${animals}">
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                    <div class="card">
                        <img src="data:image/jpeg;base64,${animal.image}" alt="${animal.name}" class="card-img-top">
